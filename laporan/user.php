...
<page backtop="14mm" backbottom="14mm" backleft="10mm" backright="10mm" pagegroup="new">
    ...
    <table border="1" align="center" id="laporan">
        ...
        <?php
            ...
            $sql = "SELECT id, username, fullname, level FROM user";
            ...
            while($row = $result->fetch_assoc()) {
                $n++;
                                        ?>
        <tr>
        <td align="center"><?php echo $n;?></td><td><?php echo $row["id"]; ?></td><td><?php echo $row["username"]; ?></td><td><?php echo $row["fullname"]; ?></td><td><?php echo $row["level"]; ?></td>
        </tr>
        <?php
    }
}

...
<page backtop="14mm" backbottom="14mm" backleft="10mm" backright="10mm" pagegroup="new">
    ...
    <hr />
    <p align="center"><b>DETAIL SURAT MASUK</b></p>
    ...
    <table id="laporan">
        ...
        <tr>
            <td style="width: 160px; font-weight: bold;">TANGGAL TERIMA</td><td style="width:480px;">: <?php echo $row["incoming_at"];?></td>
        </tr>
        <tr>
        ...
        <tr>
            <td style="width: 160px; font-weight: bold;">PENGIRIM</td><td style="width:480px;">: <?php echo $row["mail_from"];?></td>
        </tr>
        <tr>

...
<page backtop="14mm" backbottom="14mm" backleft="10mm" backright="10mm" pagegroup="new">
    ...
    <table border="1" align="center" id="laporan">
        <tr align="center" bgcolor="#dddddd">
            ...
            <th style="width: 50px;">ID DISPOSISI</th>
            <th style="width: 50px;">ID SURAT</th>
            <th style="width: 70px;">TANGGAL DISPOSISI</th>
            <th style="width: 70px">DISPOSISI OLEH</th>
            <th style="width: 80px;">TANGGAPAN</th>
            <th style="width: 80px;">DESKRIPSI</th>
        </tr>
        <?php

...
<page backtop="14mm" backbottom="14mm" backleft="10mm" backright="10mm" pagegroup="new">
    ...
    <hr />
    <p align="center"><b>DATA SURAT KELUAR</b></p>
    ...
    <table border="1" align="center" id="laporan">
        <tr align="center" bgcolor="#dddddd">
            ...
            <th style="width: 30px;">ID Surat</th>
        ...
        <?php
            ...
            $sql = "SELECT * FROM mail_out WHERE mail_date between '$tgl1' AND '$tgl2' ORDER BY id desc";
    ...
    echo "<tr><td colspan=\"8\"><i>data yg di cari tidak ada</i></td> </tr>";
}
        ?>
    </table>
</page>
...
try
{
    ...
    $html2pdf->Output('SuratKeluar.pdf');
}

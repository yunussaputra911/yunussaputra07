...
<page orientation="paysage" backtop="14mm" backbottom="14mm" backleft="10mm" backright="10mm" pagegroup="new">
    ...
    <p align="center"><?php echo "Dari Tanggal ".$tgl1." Sampai Tanggal ".$tgl2;?></p>
    ...
    <table border="1" align="center" id="laporan">
        <tr align="center" bgcolor="#dddddd">
            ...
            <th style="width: 60px;">Tanggal Surat</th>
            <th style="width: 60px;">Pengirim</th>
            <th style="width: 60px;">Surat Untuk</th>
            <th style="width: 60px;">Subjek Surat</th>
            <th style="width: 70px;">Deskripsi</th>
            <th style="width: 80px;">File Upload</th>
        </tr>
        <?php
            require_once("../koneksi.php");
            $sql = "SELECT * FROM mail WHERE incoming_at between '$tgl1' AND '$tgl2' ORDER BY id desc ";
        ...
        <td style="width: 60px;"><?php echo $row["mail_to"]; ?></td>
        <td style="width: 60px;"><?php echo $row["mail_subject"]; ?></td>
    ...
    echo "<tr><td colspan=\"10\"><i>data yg di cari tidak ada</i></td> </tr>";
}
        ?>
    </table>
</page>
